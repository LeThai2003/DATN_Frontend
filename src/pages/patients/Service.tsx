...
const services = [
    {
        ...
        description: `Dịch vụ Khám Nội tổng quát giúp phát hiện sớm các bệnh lý tiềm ẩn, 
kiểm tra sức khỏe toàn thân, tư vấn chế độ dinh dưỡng và sinh hoạt hợp lý. 
Bệnh nhân sẽ được thăm khám lâm sàng, chỉ định xét nghiệm máu, nước tiểu, chẩn đoán hình ảnh 
(Siêu âm, X-quang, ECG...) để đánh giá tổng thể tình trạng sức khỏe.`,
        price: 300000,
    ...
    },
    {
        ...
        description: `Dịch vụ Khám Ngoại tập trung vào chẩn đoán và điều trị các bệnh lý liên quan đến 
hệ cơ xương khớp, chấn thương, vết thương phần mềm, gãy xương, thoát vị, viêm ruột thừa, trĩ, u bướu dưới da, v.v. 
Bác sĩ Ngoại sẽ thăm khám, chỉ định cận lâm sàng (siêu âm, X-quang, xét nghiệm…) 
và tư vấn phương án điều trị nội khoa hoặc phẫu thuật khi cần thiết. 
Dịch vụ giúp người bệnh được chẩn đoán nhanh chóng, an toàn và hiệu quả.`,
        price: 500000,
    ...
    },
    {
        ...
        description: `Dịch vụ Khám Da liễu chuyên chẩn đoán, tư vấn và điều trị các bệnh lý về da 
như mụn trứng cá, viêm da, nấm da, dị ứng, nám, tàn nhang, rụng tóc và lão hóa da. 
Bác sĩ Da liễu sẽ thăm khám bằng các phương pháp hiện đại và tư vấn phác đồ điều trị phù hợp.`,
        price: 250000,
        doctors: [employees[2]],
    },
    {
        ...
        description: `Dịch vụ Khám Nhi khoa dành cho trẻ em từ sơ sinh đến vị thành niên, 
bao gồm theo dõi phát triển thể chất, tiêm chủng, khám bệnh cấp – mạn tính và tư vấn dinh dưỡng. 
Bác sĩ Nhi có kinh nghiệm lâu năm trong việc chăm sóc và điều trị các bệnh lý thường gặp ở trẻ.`,
        price: 350000,
        doctors: [employees[3]],
    },
    {
        ...
        description: `Dịch vụ Khám Tim mạch giúp phát hiện sớm và điều trị các bệnh lý về tim như tăng huyết áp, 
thiếu máu cơ tim, rối loạn nhịp tim, suy tim, bệnh van tim và các yếu tố nguy cơ tim mạch khác. 
Bệnh nhân sẽ được siêu âm tim, đo điện tim và tư vấn điều trị phù hợp.`,
        price: 600000,
        doctors: [employees[1]],
    },
    {
        ...
        description: `Khám Mắt giúp phát hiện sớm và điều trị các bệnh lý như cận thị, viễn thị, loạn thị, 
viêm kết mạc, đục thủy tinh thể, tăng nhãn áp, tật khúc xạ... 
Bệnh nhân sẽ được đo thị lực, soi đáy mắt và tư vấn điều trị hoặc phẫu thuật khi cần thiết.`,
        price: 280000,
        doctors: [employees[0]],
    },
    {
        ...
        description: `Khám Tai Mũi Họng chuyên điều trị các bệnh lý về hô hấp trên như viêm xoang, viêm họng, 
viêm tai giữa, ù tai, viêm amidan, viêm mũi dị ứng... 
Bác sĩ sẽ sử dụng thiết bị nội soi hiện đại để chẩn đoán và điều trị hiệu quả.`,
        price: 300000,
    ...
    },
    {
        ...
        description: `Khám Răng - Hàm - Mặt bao gồm kiểm tra, tư vấn và điều trị các vấn đề về răng miệng 
như sâu răng, viêm nướu, chỉnh nha, nhổ răng, tẩy trắng và trồng răng. 
Bác sĩ sẽ đảm bảo tính thẩm mỹ và sức khỏe răng miệng tối ưu cho bệnh nhân.`,
        price: 400000,
        doctors: [employees[2]],
    },
];
